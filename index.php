<!doctype html><html><head><meta charset="gb2312"> 
  <title>Hacked By NOVA</title> 
   
   
  <meta name="title" content="You System Have Been Down!"> 
  <meta name="keywords" content="Hacked By NOVA"> 
  <meta name="description" content="NOVA Was Here! Your Site Security Is Too Low. So, I Hacked It. Upgrade Your Security Level."> 
  ...
  <meta property="og:title" content="This site hacked by NOVA"> 
 ...
 <body> 
  ...
  <div class="twinkling"> 
   <center> 
    ...
    <br> 
    <center> 
     <h1 class="t3x"> <font color="lime" style="text-shadow: 0 0 20px blue, 0 0 5px red, 0 0 7px red, 0 0 45px red; font-weight:bold: red;font-size:50px"> HACKED BY NOVA </font> </h1> 
     <br> 
    </center> 
    <div class="container"> 
     <div class="text"></div> 
     ...
     <div style="text-shadow: 0px 0px 10px green;"> 
      ...
      <b> 
       <marquee scrollamount="5" direction="left" width="70%"> 
        <font face="Play" color="red" class="cn"> NOVA <font color="cyan">|<font color="lime"></font><font color="cyan">|</font> </font>  <font color="cyan">|</font> .. <font color="cyan"> | </font> .. <font color="cyan">|</font> .. <font color="cyan"> | </font> .. <font color="cyan">|
       </marquee> </b> 
  ...
  <font face="Sarpanch" color="white" size"10" class="message"><b><font face="Sarpanch" color="white" size"10" class="message"><font face="Play"><font color="cyan"> 
       ...
       <audio src="https://archive.org/download/untitled-video-made-with-clipchamp-14_202308/Untitled video - Made with Clipchamp (14).mp3" loop="1" autoplay="1"></audio> </font></font></font> </b></font> 
